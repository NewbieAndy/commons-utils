package com.newbieandy.pagination;
...
public class Pagination extends SimplePage {
    ...
    private static final long serialVersionUID = -8008893811376689198L;
...
//        pageView.add("共<var>" + getTotalPage() + "</var>页 到第<input type='text' id='PAGENO'  size='3' />页 <input type='button' id='skip' class='hand btn60x20' value='确定' onclick=\"javascript:window.location.href = '" + url + "?" + params + "&pageNo=' + $('#PAGENO').val() \"/>");
        pageView.add("共<var>" + getTotalPage() + "</var>页 到第<input type='text' id='PAGENO'  size='3' />页  <a href=\"javascript:void(0);\" onclick=\"javascript:window.location.href='" + url + "?" + params + "&pageNo='+document.getElementById('PAGENO').value+''\"><font size=2>跳转</font></a>");
    }
}
